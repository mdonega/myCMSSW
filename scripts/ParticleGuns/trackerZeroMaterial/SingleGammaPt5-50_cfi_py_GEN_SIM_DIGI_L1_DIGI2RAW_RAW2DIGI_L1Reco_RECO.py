...
# with command line options: Configuration/Generator/python/SingleGammaPt35_cfi.py --step GEN,SIM,DIGI,L1,DIGI2RAW,RAW2DIGI,L1Reco,RECO --conditions START61_V11::All --eventcontent RECOSIM --datatier RECOSIM --geometry Extended --customise_commands=process.generator.PGunParameters.MinPt=5.0\nprocess.generator.PGunParameters.MaxPt=50\nprocess.generator.PGunParameters.MinEta=1.5\nprocess.generator.PGunParameters.MaxEta=2.6\n
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('SingleGammaPt5-50_cfi_py_GEN_SIM_DIGI_L1_DIGI2RAW_RAW2DIGI_L1Reco_RECO.root'),
